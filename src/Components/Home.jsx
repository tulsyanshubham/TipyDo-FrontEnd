...
const Home = () => {
  ...
  return (
    <div className='w-[100%] h-full bg-gray-900 overflow-x-hidden'>
      ...
      <section className='m-5 bg-slate-800  rounded-xl p-5'>
        <div className='mt-2 mb-10 flex flex-col justify-center items-center'>
          <p className='text-3xl text-blue-800 font-semibold toporigin '> Where to display your <span className='text-green-600 font-bold'>QR codes:</span> </p>

          <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-36 text-center py-8 px-12 sm:px-0 mt-5'>

            <div className='shadow-md shadow-gray-500 rounded-md bottomorigin duration-200 hover:scale-105'>
      ...
      <div className='flex flex-col justify-center items-center  mt-36'>
        <p className='text-4xl text-blue-800 font-semibold toporigin'>Features for <span className='text-green-600 font-bold '>Restaurant</span>  Teams.</p>

        <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-36 text-center py-8 px-12 sm:px-0 mt-5'>

          <div className='sm:pt-10 hover:scale-110 duration-300 leftorigin'>
            <img src="/res1.svg" className='h-28 ml-12 sm:ml-10 ' alt="" />
          ...
          <div className='sm:pt-10 hover:scale-110 duration-300 bottomorigin'>
            <img src="/res2.svg" className='h-24  ml-14 sm:ml-14 pb-2 ' alt="" />
          ...
          <div className='sm:pt-10 hover:scale-110 duration-300 rightorigin'>
            <img src="/res3.svg" className='h-24 ml-14 sm:ml-14 sm:pb-2 ' alt="" />
      ...
      <section className='mt-5 mx-5 bg-slate-800  rounded-xl p-5'>
        <div className='mt-2  flex flex-col justify-center items-center'>
          <p className='text-3xl text-blue-600 font-semibold toporigin'>Digital tip jars for your restaurant </p>

          <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-24 text-center py-8 px-8 sm:px-0 mt-5'>

            <div className='shadow-md shadow-gray-500 rounded-md duration-200 hover:scale-105 leftorigin'>
            ...
            <div className='shadow-md shadow-gray-500 rounded-md duration-200 hover:scale-105 bottomorigin'>
            ...
            <div className='shadow-md  shadow-gray-500 rounded-md duration-200 hover:scale-105 rightorigin'>
      ...
      <div className='flex w-[100%] items-center justify-center p-5 text-white text-sm'>
        &copy; 2024 eTipⓇ. All Rights Reserved.
      </div>
    </div>
