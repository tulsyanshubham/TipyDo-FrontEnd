    ...
    <div className='overflow-x-hidden pt-[10vh] min-h-[100vh] bg-gray-800'>
      ...
      <div className="w-screen h-full">
        ...
        <div className='mt-4 px-4 flex flex-col  items-center justify-evenly flex-wrap gap-5'>
          ...
          <div className='flex mt-12 items-center justify-center  relative qr-box'>
          ...
          <div>
            <button className='bg-teal-400 px-2 py-2 rounded-xl hover:scale-110 duration-300 border-2 border-teal-200'>View Clients</button>
          </div>
        </div>
